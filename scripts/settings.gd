...
var net_indicators := true  # Show in-game network ping overlay
...
# UPDATED: add new_scale_3d and new_net_indicators
func set_and_save(new_fullscreen: bool, new_vsync: bool, new_quality: int, new_tex_quality: int, new_scale_3d: float, new_net_indicators: bool = true) -> void:
