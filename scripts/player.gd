...
func _handle_shoot() -> void:
	var shoot_action := "shoot_touch" if is_mobile else "shoot"

	if aim_active and current_ball != null and Input.is_action_just_pressed(shoot_action) and _cooldowns["shoot"] == 0.0:
